...
if (distancia < 3 ){
    digitalWrite(led1, 0);                     // en alto el pin 13 si la distancia es menor a 10cm
    digitalWrite(led2, 0); 
  }
 ...
 if (distancia < 20 ){
    digitalWrite(led2, 1);                     // en alto el pin 13 si la distancia es menor a 10cm
    digitalWrite(led1, 0); 
...
if (distancia < 18 ){
    digitalWrite(led2, 0);                     // en alto el pin 13 si la distancia es menor a 10cm
    digitalWrite(led1, 0); 
