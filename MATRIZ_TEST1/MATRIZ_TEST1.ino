...
byte R[]={0x78,0x44,0x44,0x78,0x70,0x58,0x4A,0x43};
byte P[]={0x78,0x44,0x44,0x78,0x40,0x40,0x40,0x40};
byte H[]={0x42,0x42,0x42,0x7E,0x42,0x42,0x42,0x42};
byte L[]={0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x7E};
byte C[] = { 0x3C, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x3C }; 
byte N[]={0x42,0x62,0x52,0x4A,0x46,0x42,0x42,0x42};
...
void loop(){ 
  String s = "KODEMYRPHLCN " ; //PALABRA A IMPRIMIR
